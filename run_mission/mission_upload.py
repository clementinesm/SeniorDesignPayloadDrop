...
# ---- removed because the connection is now established in run file ----
"""
...
# I removed the set_home command from this script, should check if it works
"""
# note: wilson HAD to have a home point, I think I have gotten by w/o one
...
def run_mission_upload(missionfile):
    uploadmission(missionfile)
