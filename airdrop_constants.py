...
APPROACH_ANGLE_N = 110*np.pi/180   # rad
APPROACH_ANGLE_S = -70*np.pi/180   # rad
C_D = 0.325               # drap coefficient of payload
D_APPROACH = 95.         # approach distance (m)
...
WIND_ANGLE = 110*PI/180   # Wind direction measured from x axis (rad)
WIND_SPEED = 3.1          # Wind speed (m/s)